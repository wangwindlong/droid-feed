...
class NotificationFragment : BaseInjectFragment<EmptyViewModel, FragmentHomeBinding>(EmptyViewModel::class.java, "feed") {
    ...
    override fun initViewModel(viewModel: EmptyViewModel) {
        ...
        mBinding.text = "NotificationFragment"
        mBinding.index = 2
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        mViewModel.jump2Fragment.observe(viewLifecycleOwner, EventObserver{ index ->
            ...
            ft.addToBackStack("NotificationFragment\$fragment$index")
            ft.commit()
        })
        return view
    }
