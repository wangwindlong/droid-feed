...
class SettingFragment : BaseInjectFragment<EmptyViewModel, FragmentHomeBinding>(EmptyViewModel::class.java, "feed") {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        mViewModel.jump2Fragment.observe(viewLifecycleOwner, EventObserver{ index ->
            ...
            ft.addToBackStack("SettingFragment\$fragment$index")
            ft.commit()
        })
        return view
    }
